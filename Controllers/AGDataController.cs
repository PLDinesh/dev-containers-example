...
namespace dev_containers_example.Controllers;

[ApiController]
[Route("[controller]/[action]")]
public class AGDataController : ControllerBase
{

    private static readonly string[] ITSkills = { "android", "css", "html5", "mac", "windows" };

    private static readonly string[] FirstNames = {"Sophie", "Isabelle", "Emily", "Olivia", "Lily", "Chloe", "Isabella",
    "Amelia", "Jessica", "Sophia", "Ava", "Charlotte", "Mia", "Lucy", "Grace", "Ruby",
    "Ella", "Evie", "Freya", "Isla", "Poppy", "Daisy", "Layla"};

    private static readonly string[] LastNames = { "Beckham", "Black", "Braxton", "Brennan", "Brock", "Bryson", "Cadwell",
    "Cage", "Carson", "Chandler", "Cohen", "Cole", "Corbin", "Dallas", "Dalton", "Dane",
    "Donovan", "Easton", "Fisher", "Fletcher", "Grady", "Greyson", "Griffin", "Gunner",
    "Hayden", "Hudson", "Hunter", "Jacoby", "Jagger", "Jaxon", "Jett", "Kade", "Kane",
    "Keating", "Keegan", "Kingston", "Kobe"};

    private static readonly string[] ITSkillsNames = { "Android", "CSS", "HTML 5", "Mac", "Windows" };
    private static readonly string[] Addresses = {  "1197 Thunder Wagon Common, Cataract, RI, 02987-1016, US, (401) 747-0763",
    ...
    [HttpGet(Name = "GetITSkills")]
    public string[] GetITSkills()
    {
        return ITSkills;
    }

    [HttpGet(Name = "GetITSkillNames")]
    public string[] GetITSkillNames()
    {
        return ITSkillsNames;
    }

    [HttpGet(Name = "GetFirstName")]
    public string[] GetFirstName()
    {
        return FirstNames;
    }

    [HttpGet(Name = "GetLastName")]
